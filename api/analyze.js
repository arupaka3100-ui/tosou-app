...
JSONのみで返答：
{"correctedPoints":[{"x":数値,"y":数値}...],"boundaryNote":"検出した境界の特徴（日本語1文）"}`;
    try {
...
- 屋根形状を必ず識別する（gable=切妻/山型、flat=陸屋根、shed=片流れ、hip=寄棟）
...
JSONのみで返答：
{
  ...
  "roofType":"gable",
  "dimensions":[
    {"id":"width","label":"横幅","value":8.0,"confidence":"medium","note":"根拠"},
...
JSONのみで返答：
{
  "dimensions":[{"id":"width","value":8.0,"confidence":"high","note":"根拠"},{"id":"height1F","value":3.0,"confidence":"high","note":"根拠"},{"id":"height2F","value":2.8,"confidence":"medium","note":"根拠"}],
